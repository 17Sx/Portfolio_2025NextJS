...
<div className="projects-content">
  ...
  <div className="project-card">
      ...
      <Image className='project-img' src="/img/Todo.png" alt="" width={100} height={100} />
      ...
      <div className='tech-project'>
          ...
          <Image className='iconimg' src="/img/ts.png" alt=""  width={24} height={24}/>
        </div>
      </div>
    </div>
    <div className="project-card">
      ...
      <Image className='project-img' src="/img/PokeFight.png" alt="" width={100} height={100}/>
      <div className="bottom-card">
      <div className='project-btn'>
    ...
    <div className="project-card">
      ...
      <Image className='project-img' src="/img/Portfolio2024.png" alt="" width={100} height={100}/>
      <div className="bottom-card">
      <div className='project-btn'>
        <a href="https://github.com/17Sx/ToDoList_IIMA2" className="project-link">View Project</a>
        <Image src="/img/uprarr.png" alt="" width={24} height={24}/>
      ...
      <div className='tech-project'>
          ...
          <Image className='iconimg' src="/img/Sass.png" alt=""width={24} height={24} />
          <Image className='iconimg' src="/img/threejs.png" alt=""width={24} height={24} />
        </div>
      </div>
    </div>
    <div className="project-card">
      ...
      <Image className='project-img' src="/img/WeatherApp.png" alt="" width={100} height={100}/>
      <div className="bottom-card">
      <div className='project-btn'>
    ...
    <div className="project-card">
      ...
      <Image className='project-img' src="/img/PhpCrud.png" alt="" width={100} height={100}/>
      <div className="bottom-card">
      <div className='project-btn'>
    ...
    <div className="project-card">
      ...
      <Image className='project-img' src="/img/Harrycards.png" alt="" width={100} height={100}/>
      <div className="bottom-card">
      <div className='project-btn'>
        <a href="#" className="project-link">View Project</a>
        <Image src="/img/uprarr.png" alt=""  width={24} height={24}/>
