...
<div className="projects-content">
  ...
  <div className="project-card">
      ...
      <img className='project-img' src="./img/Todo.png" alt=""></img>
      ...
      <div className='tech-project'>
          ...
          <img className='iconimg' src="./img/ts.png" alt="" />
        </div>
      </div>
    </div>
    <div className="project-card">
      ...
      <img className='project-img' src="./img/PokeFight.png" alt=""></img>
      <div className="bottom-card">
      <div className='project-btn'>
    ...
    <div className="project-card">
      ...
      <img className='project-img' src="./img/Portfolio2024.png" alt=""></img>
      <div className="bottom-card">
      <div className='project-btn'>
        <a href="https://github.com/17Sx/ToDoList_IIMA2" className="project-link">View Project</a>
        <img src="./img/uprarr.png" alt="" />
      ...
      <div className='tech-project'>
          ...
          <img className='iconimg' src="./img/Sass.png" alt="" />
          <img className='iconimg' src="./img/threejs.png" alt="" />
        </div>
      </div>
    </div>
    <div className="project-card">
